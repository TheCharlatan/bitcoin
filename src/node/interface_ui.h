...
#define ADD_SIGNALS_DECL_WRAPPER(signal_name, rtype, ...)                                  \
    ...
    ADD_SIGNALS_DECL_WRAPPER(NotifyBlockTip, void, SynchronizationState, int64_t height, int64_t timestamp, const uint256& block_hash, double verfication_progress);
