    ...
    const ChainstateLoadOptions& options) EXCLUSIVE_LOCKS_REQUIRED(::cs_main)
{
    ...
    // Note that it also sets m_reindex based on the disk flag!
    // From here on, m_reindex and options.reindex values may be different!
    ...
    if (!chainman.m_blockman.m_reindex && !chainman.ActiveChainstate().LoadGenesisBlock()) {
