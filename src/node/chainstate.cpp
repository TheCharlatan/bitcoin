    ...
    const ChainstateLoadOptions& options) EXCLUSIVE_LOCKS_REQUIRED(::cs_main)
{
    ...
    auto res{chainman.MaybeRebalanceCaches()};
                                                       ...
                                                       const ChainstateLoadOptions& options)
{
    ...
    if (!snapshot_completion) {
        return {util::Error{ErrorString(snapshot_completion)}, ChainstateLoadError::FAILURE_FATAL};
    }
    ...
    if (*snapshot_completion == SnapshotCompletionResult::SKIPPED) {
        ...
        if (auto res{chainman.ValidatedSnapshotCleanup()}; !res) {
            return {util::MoveMessages(res), util::Error{}, ChainstateLoadError::FAILURE_FATAL};
        }
