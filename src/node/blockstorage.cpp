...
static BlockManager::Options&& Flatten(BlockManager::Options&& opts)
{
    if (!opts.block_tree_db_params) {
        opts.block_tree_db_params = DBParams {
            .path = opts.blocks_dir / "index",
            .cache_bytes = 0,
        };
    }
