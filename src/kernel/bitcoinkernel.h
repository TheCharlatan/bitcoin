 ...
 */
BITCOINKERNEL_API void kernel_chainstate_load_options_set_wipe_block_tree_db(
 ...
 */
BITCOINKERNEL_API void kernel_chainstate_load_options_set_block_tree_db_in_memory(
    kernel_ChainstateLoadOptions* chainstate_load_options,
