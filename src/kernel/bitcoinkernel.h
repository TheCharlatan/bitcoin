 ...
 */
BITCOINKERNEL_API const btck_BlockHeader* BITCOINKERNEL_WARN_UNUSED_RESULT btck_block_tree_entry_get_block_header(
    const btck_BlockTreeEntry* block_tree_entry) BITCOINKERNEL_ARG_NONNULL(1);
 ...
 * @param[in] current_best             Nullable. The block tree entry with the highest known work.
...
BITCOINKERNEL_API int BITCOINKERNEL_WARN_UNUSED_RESULT btck_chainstate_manager_process_block_header(
    ...
    const btck_BlockTreeEntry* current_best) BITCOINKERNEL_ARG_NONNULL(1, 2, 3);
