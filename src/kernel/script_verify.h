...
#ifndef BITCOIN_KERNEL_SCRIPT_VERIFY_H
#define BITCOIN_KERNEL_SCRIPT_VERIFY_H
...
const uint32_t SCRIPT_VERIFY_ALL{SCRIPT_VERIFY_P2SH | SCRIPT_VERIFY_WITNESS | SCRIPT_VERIFY_TAPROOT};
...
#endif // BITCOIN_KERNEL_SCRIPT_VERIFY_H
