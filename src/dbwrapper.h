...
private:
    ...
    void WriteImpl(const Span<const std::byte>& key, CDataStream& ssValue);
    void EraseImpl(const Span<const std::byte>& key);
...
private:
    ...
    void SeekImpl(const Span<const std::byte>& key);
