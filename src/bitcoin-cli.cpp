...
private:
    ...
    {
        if (gArgs.GetChainType() == ChainType::TESTNET) return " testnet";
        if (gArgs.GetChainType() == ChainType::SIGNET) return " signet";
        if (gArgs.GetChainType() == ChainType::REGTEST) return " regtest";
        return "";
    }
