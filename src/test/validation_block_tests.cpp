...
BOOST_AUTO_TEST_CASE(processnewblock_signals_ordering)
{
    ...
    BOOST_CHECK(Assert(m_node.chainman)->ProcessNewBlock(std::make_shared<CBlock>(Params().GenesisBlock()), true, true, &ignored).value());
...
BOOST_AUTO_TEST_CASE(mempool_locks_reorg)
{
    ...
    auto ProcessBlock = [&](std::shared_ptr<const CBlock> block) -> bool {
        return Assert(m_node.chainman)->ProcessNewBlock(block, /*force_processing=*/true, /*min_pow_checked=*/true, /*new_block=*/&ignored).value();
    };
