...
struct BasicTestingSetup {
    ...
    explicit BasicTestingSetup(const std::string_view chainName = kernel::chainname::MAIN, const std::vector<const char*>& extra_args = {});
    ~BasicTestingSetup();
...
struct ChainTestingSetup : public BasicTestingSetup {
    ...
    explicit ChainTestingSetup(const std::string_view chainName = kernel::chainname::MAIN, const std::vector<const char*>& extra_args = {});
    ~ChainTestingSetup();
};
...
struct TestingSetup : public ChainTestingSetup {
    ...
    explicit TestingSetup(
        const std::string_view chainName = kernel::chainname::MAIN,
...
struct RegTestingSetup : public TestingSetup {
    RegTestingSetup()
        : TestingSetup{kernel::chainname::REGTEST} {}
};
...
struct TestChain100Setup : public TestingSetup {
    TestChain100Setup(
        const std::string_view chain_name = kernel::chainname::REGTEST,
        const std::vector<const char*>& extra_args = {},
        const bool coins_db_in_memory = true,
        const bool block_tree_db_in_memory = true);
...
std::unique_ptr<T> MakeNoLogFileContext(const std::string_view chain_name = kernel::chainname::REGTEST, const std::vector<const char*>& extra_args = {})
{
