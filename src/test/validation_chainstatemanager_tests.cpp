...
BOOST_FIXTURE_TEST_CASE(chainstatemanager_rebalance_caches, TestChain100Setup)
{
    ...
    chainstates.push_back(&c1);
    {
        ...
        Assert(manager.MaybeRebalanceCaches());
    }
...
BOOST_FIXTURE_TEST_CASE(chainstatemanager_snapshot_completion, SnapshotTestSetup)
{
    ...
    auto res_1 = WITH_LOCK(::cs_main, return chainman.MaybeCompleteSnapshotValidation());
    BOOST_CHECK_EQUAL(res_1.value(), SnapshotCompletionResult::SUCCESS);
    ...
    auto res_2 = WITH_LOCK(::cs_main, return chainman.MaybeCompleteSnapshotValidation());
    BOOST_CHECK_EQUAL(res_2.value(), SnapshotCompletionResult::SKIPPED);
...
BOOST_FIXTURE_TEST_CASE(chainstatemanager_snapshot_completion_hash_mismatch, SnapshotTestSetup)
{
...

    {
        ...
        auto res = WITH_LOCK(::cs_main, return chainman.MaybeCompleteSnapshotValidation());
        BOOST_CHECK_EQUAL(res.GetFailure(), FatalCondition::SnapshotHashMismatch);
    }
