...
BOOST_AUTO_TEST_CASE(stale_tip_peer_management)
{
    ...
    auto peerLogic = PeerManager::make(*connman, *m_node.addrman, nullptr, *m_node.chainman, *m_node.mempool, {}, m_node.exit_status);
...
BOOST_AUTO_TEST_CASE(peer_discouragement)
{
    ...
    auto connman = std::make_unique<ConnmanTestMsg>(0x1337, 0x1337, *m_node.addrman, *m_node.netgroupman, Params());
    auto peerLogic = PeerManager::make(*connman, *m_node.addrman, banman.get(), *m_node.chainman, *m_node.mempool, {}, m_node.exit_status);
