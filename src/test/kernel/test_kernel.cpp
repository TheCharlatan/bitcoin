...
Context create_context(std::shared_ptr<TestKernelNotifications> notifications, kernel_ChainType chain_type, std::shared_ptr<TestValidationInterface> validation_interface = nullptr)
{
    ContextOptions options{};
