...
void chainman_test()
{
    ...
    {
        ChainstateManagerOptions opts{context, "\0://"};
        assert(!opts);
    }

    {
        BlockManagerOptions opts{context, "\0://"};
        assert(!opts);
    }
    ...
    BlockManagerOptions blockman_opts{context, (test_directory.m_directory / "blocks").string()};
