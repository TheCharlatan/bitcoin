...
protected:
    ...
    void BlockConnected(ChainstateRole role, const std::shared_ptr<const CBlock>& block, const std::shared_ptr<CBlockUndo> blockundo, const CBlockIndex* pindex) override;
