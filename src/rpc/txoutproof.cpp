    ...
    return RPCHelpMan{"gettxoutproof",
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
        {
            ...
            if (pblockindex == nullptr) {
                const CTransactionRef tx = GetTransaction(/*block_index=*/nullptr, /*mempool=*/nullptr, *setTxids.begin(), chainman.GetConsensus(), hashBlock, chainman.BlocksDirPath(), chainman.FastPrune());
            ...
            CBlock block;
            if (!ReadBlockFromDisk(chainman.BlocksDirPath(), chainman.FastPrune(), block, pblockindex, chainman.GetConsensus())) {
