    ...
    return RPCHelpMan{"gettxoutproof",
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
        {
            ...
            if (pblockindex == nullptr) {
                const CTransactionRef tx = GetTransaction(/*block_index=*/nullptr, /*mempool=*/nullptr, *setTxids.begin(), chainman.GetConsensus(), hashBlock, chainman.BlocksDirPath());
            ...
            CBlock block;
            if (!ReadBlockFromDisk(chainman.BlocksDirPath(), block, pblockindex, chainman.GetConsensus())) {
