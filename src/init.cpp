...
bool AppInitMain(NodeContext& node, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    chainman.m_load_block = std::thread(&util::TraceThread, "loadblk", [=, &chainman, &args] {
        ThreadImport(chainman, vImportFiles, args.GetBoolArg("-stopafterblockimport", DEFAULT_STOPAFTERBLOCKIMPORT), args.GetBoolArg("-persistmempool", DEFAULT_PERSIST_MEMPOOL));
    });
