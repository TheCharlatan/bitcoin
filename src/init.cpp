...
bool AppInitMain(NodeContext& node, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    node.validation_signals->RegisterBackgroundSignalScheduler(*node.scheduler);
    ...
    if (!peerman_opts.ignore_incoming_txs) {
        ...
        node.validation_signals->RegisterValidationInterface(fee_estimator);
    }
    ...
    if (g_zmq_notification_interface) {
        node.validation_signals->RegisterValidationInterface(g_zmq_notification_interface.get());
    }
#endif
