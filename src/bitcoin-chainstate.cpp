...
{
public:
    void BlockTipHandler(kernel_SynchronizationState state, const BlockIndex index) override
    {
...
int main(int argc, char* argv[])
{
    ...
    Logger logger{[](std::string_view message){ std::cout << "kernel: " << message;}, logging_options};
