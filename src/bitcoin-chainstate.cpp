...
int main(int argc, char* argv[])
{
    ...
    public:
        ...
        {
            std::cout << "Received start shutdown notification: " << InterruptReasonToString(reason);
        }
    };
    ...
    ChainstateManager chainman{kernel_context.cancel, chainman_opts, blockman_opts};
