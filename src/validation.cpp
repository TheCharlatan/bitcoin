...
ChainstateManager::ChainstateManager(ValidationSignals& signals, const util::SignalInterrupt& interrupt, Options options, node::BlockManager::Options blockman_options)
