...
util::Result<bool, FatalError> Chainstate::DisconnectTip(BlockValidationState& state, DisconnectedBlockTransactions* disconnectpool)
{
    ...
    // TODO: Add rationale for returning early on a fatal flush error here.
...
util::Result<bool, FatalError> Chainstate::ActivateBestChain(BlockValidationState& state, std::shared_ptr<const CBlock> pblock)
{
    ...
    do {
        ...
        if (exited_ibd) {
            ...
            LOCK(::cs_main);
            // TODO: Add rationale for not returning early on a fatal error here.
    ...
    // TODO: Add rationale for propagating a fatal flush error here.
                ...
                while (!queue.empty()) {
                    ...
                    while (range.first != range.second) {
                        ...
                        if (m_blockman.ReadBlockFromDisk(*pblockrecursive, it->second)) {
                            ...
                            // TODO: Add reason why continuing processing here after a fatal error is fine.
