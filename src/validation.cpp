...
bool FatalError(BlockValidationState& state, const std::string& strMessage, ValidationNotifications& notifications, const bilingual_str& userMessage)
{
...
bool Chainstate::ConnectTip(BlockValidationState& state, CBlockIndex* pindexNew, const std::shared_ptr<const CBlock>& pblock, ConnectTrace& connectTrace, DisconnectedBlockTransactions& disconnectpool)
{
    ...
    if (this != &m_chainman.ActiveChainstate()) {
        ...
        m_chainman.MaybeCompleteSnapshotValidation(
            [&notifications = m_chainman](bilingual_str msg) {
...
{
    return m_options.notifications->doWarning(warning);
}

bool ChainstateManager::FatalError(const std::string& strMessage, bilingual_str user_message) const
{
    return m_options.notifications->fatalError(strMessage, user_message);
}
        ...
        bool in_memory)
{
    ...
    if (!snapshot_ok) {
        ...
        if (auto snapshot_datadir = node::FindSnapshotChainstateDir()) {
            ...
            if (!removed) {
                this->FatalError(strprintf("Failed to remove snapshot chainstate dir (%s). "
